      ...
      <a-tab-pane key="1" tab="Sign up">
        <b-form @submit="submitSignUp" class="formSignUp">
          <b-form-group id="input-group-1" label="FullName :" label-for="input-1">
            <b-form-input id="input-1" v-model="SignUp.fullName" type="text" placeholder="Enter " required></b-form-input>
          </b-form-group>

          <b-form-group id="input-group-1" label="BirthDay :" label-for="input-1">
            <b-form-input id="input-1" v-model="SignUp.birthDay" type="date" placeholder="Enter " required></b-form-input>
          </b-form-group>

          <b-form-group id="input-group-1" label="Address :" label-for="input-1">
            <b-form-input id="input-1" v-model="SignUp.address" type="text" placeholder="Enter " required></b-form-input>
          </b-form-group>

          <b-form-group id="input-group-1" label="PhoneNumber :" label-for="input-1">
            <b-form-input id="input-1" v-model="SignUp.phoneNumber" type="number" placeholder="Enter "
              required></b-form-input>
          </b-form-group>

          <b-form-group id="input-group-1" label="Email :" label-for="input-1">
            <b-form-input id="input-1" v-model="SignUp.email" type="email" placeholder="Enter " required></b-form-input>
          </b-form-group>
          <b-form-group id="input-group-1" label="Password :" label-for="input-1">
            <b-form-input id="input-1" v-model="SignUp.password" type="password" placeholder="Enter "
              required></b-form-input>
          </b-form-group>
          ...
          <b-form-group id="input-group-1" label="Head Quater" style="width: 100%">
            <a-select @change="onChange($event)" v-decorator="[
              'headQuarterId',
              {
                rules: [
                  {
          ...
          <b-form-group id="input-group-1" label="Description :" label-for="input-1">
            <b-form-input id="input-1" v-model="SignUp.description" type="text" placeholder="Enter "
              required></b-form-input>
          </b-form-group>
          ...
          <div class="mt-6 table">
            <table id="customers " class="w-full">
              ...
              <tr>
                <td></td>
                <td>
                  <b-form-input id="input-1" class="inputLogin" type="text" placeholder="Tìm kiếm" v-model="userName"
                    @input="searchName"></b-form-input>
                </td>
                <td></td>
                <td></td>
              </tr>
              <tr v-for="(item, index) in data" :key="index">
                ...
                <td class="w-1/5">
                  <b-form-input v-model="item.password" class="w-full h-8" v-if="isEdit" />
                  <div v-else>*******</div>
                </td>
                <td style="text-align: center" class="w-40">
                  <div class="listBtn">
                    ...
                    <a-popconfirm placement="topRight" ok-text="Có" cancel-text="Không" @confirm="confirm(item.userId)">
                      <template slot="title">
                        <p>{{ textDelete }}</p>
                      </template>
